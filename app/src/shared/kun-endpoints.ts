...
/**
 * 引擎无关的端点别名。
 * 旧代码继续使用 KUN_*_PATH；新代码可用 ENGINE_*_PATH。
 * 两组常量当前指向同一字符串，未来如切换端点语义可独立演进。
 */
export const ENGINE_HEALTH_PATH = KUN_HEALTH_PATH
export const ENGINE_RUNTIME_INFO_PATH = KUN_RUNTIME_INFO_PATH
export const ENGINE_RUNTIME_TOOLS_PATH = KUN_RUNTIME_TOOLS_PATH
export const ENGINE_SKILLS_PATH = KUN_SKILLS_PATH
export const ENGINE_THREADS_PATH = KUN_THREADS_PATH
export const ENGINE_ATTACHMENTS_PATH = KUN_ATTACHMENTS_PATH
export const ENGINE_MEMORY_PATH = KUN_MEMORY_PATH
export const ENGINE_THREAD_TEMPLATE = KUN_THREAD_TEMPLATE
export const ENGINE_THREAD_TURNS_TEMPLATE = KUN_THREAD_TURNS_TEMPLATE
export const ENGINE_THREAD_REVIEW_TEMPLATE = KUN_THREAD_REVIEW_TEMPLATE
export const ENGINE_THREAD_COMPACT_TEMPLATE = KUN_THREAD_COMPACT_TEMPLATE
export const ENGINE_THREAD_FORK_TEMPLATE = KUN_THREAD_FORK_TEMPLATE
export const ENGINE_THREAD_GOAL_TEMPLATE = KUN_THREAD_GOAL_TEMPLATE
export const ENGINE_THREAD_TODOS_TEMPLATE = KUN_THREAD_TODOS_TEMPLATE
export const ENGINE_ATTACHMENT_TEMPLATE = KUN_ATTACHMENT_TEMPLATE
export const ENGINE_ATTACHMENT_CONTENT_TEMPLATE = KUN_ATTACHMENT_CONTENT_TEMPLATE
export const ENGINE_MEMORY_RECORD_TEMPLATE = KUN_MEMORY_RECORD_TEMPLATE
export function engineThreadPath(id: string): string { return kunThreadPath(id) }
export function engineThreadTurnsPath(id: string): string { return kunThreadTurnsPath(id) }
