...
import { getSandboxManager } from '../tools/filesystem/sandbox-manager.js';
import type { SandboxMode } from '../tools/filesystem/sandbox-config.js';
...
export { getSandboxManager } from '../tools/filesystem/sandbox-manager.js';
export type { SandboxMode } from '../tools/filesystem/sandbox-config.js';