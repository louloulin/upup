...
export const getInvestmentStrategiesTool = new PiTool({
...
export const getCompanyProfileTool = new PiTool({
...
export const trackCompanyTool = new PiTool({
  name: 'track_company',
...
export const getRisksTool = new PiTool({
  name: 'get_risks',
...
export const trackRiskTool = new PiTool({
  name: 'track_risk',
...
export const getSectorsTool = new PiTool({
  name: 'get_sectors',
...
export const trackSectorTool = new PiTool({
  name: 'track_sector',
...
export const getKnowledgeSummaryTool = new PiTool({
