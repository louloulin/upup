...
import { getApprovalConfig, setApprovalConfig, getTimeoutForTool } from '../../utils/permissions/index.js'
...
import { getApprovalManager } from '../../utils/permissions/ApprovalManager.js'
