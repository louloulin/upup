...
for (const packageName of ['pi-finance-sdk', 'pi-market-data', 'pi-investment-analysis', 'pi-risk', 'pi-portfolio', 'pi-backtest', 'pi-platform', 'pi-research', 'pi-browser', 'pi-config', 'pi-cache', 'pi-notify', 'pi-investment-workflow', 'pi-management', 'pi-technical'] {
