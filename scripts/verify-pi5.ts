...
const checks: readonly Check[] = [
  ...
  { id: 'A8', name: 'Pi Session tree/compact/recovery', command: 'bun', args: ['test', 'src/runtime/pi/session-service.test.ts', 'src/runtime/pi/finance-context.test.ts', 'src/runtime/pi/reliability.test.ts'] },
