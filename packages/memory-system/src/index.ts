...
import { getApiKeyNameForProvider } from '@upup/utils/env';
...
// Re-export additional modules (added in L4 modularization)
export { getObservationBuffer, type ToolObservation } from './observation-buffer.js';
export { runMemoryFlush, shouldRunMemoryFlush, MEMORY_FLUSH_TOKEN } from './flush.js';

export { parseSessionTranscripts, shouldUpdateSessionMemory, updateSessionMemory, type SessionEntry } from './session-files.js';
export { MemoryDenyManager } from './memory-deny.js';
export { MemoryAuditLogger, getAuditLogger, resetAuditLogger, type MemoryAuditEntry } from './memory-audit.js';
export { chunkMemoryText, buildSnippet, estimateChunkTokens, countLinesInChunk } from './chunker.js';
export { DEFAULT_MMR_CONFIG, tokenize, jaccardSimilarity, applyMMRToHybridResults } from './mmr.js';
export { DEFAULT_TEMPORAL_DECAY, toDecayLambda, calculateTemporalDecayMultiplier, applyTemporalDecay } from './temporal-decay.js';
export { encrypt, decrypt, encryptToFile, decryptFromFile, isEncrypted, generateMasterKey, isEncryptionAvailable, type EncryptionConfig, type EncryptedPayload } from './crypto.js';
export { createEmbeddingClient, embedSingleQuery } from './embeddings.js';
export { EncryptedMemoryStore } from './encrypted-store.js';
export { InvestmentMemory, useInvestmentMemory, __resetInvestmentMemory, type InvestmentMemoryKind, type InvestmentDecision, type RecordDecisionInput } from './investment-memory.js';
export { TeamMemoryPaths, getTeamMemoryPaths, resetTeamMemoryPaths, generateTeamPrompt, loadTeamSharedMemory, saveTeamSharedMemory, teamMem, type TeamMemoryPath, type TeamMemoryConfig, type TeamMemberContext } from './team-paths.js';
// nested-paths: re-export everything except the conflicting MemoryScope type
export { NestedMemoryPaths, getNestedMemoryPaths, resetNestedMemoryPaths, registerDefaultMemoryPaths, type NestedMemoryPath, type PathResolutionOptions } from './nested-paths.js';
