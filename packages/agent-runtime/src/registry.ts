 ...
 */
const CODING_AGENT: AgentDefinition = {
  id: 'coding-agent',
  name: 'Coding Agent',
 ...
 */
const DEBUGGING_AGENT: AgentDefinition = {
  id: 'debugging-agent',
 ...
 */
const TESTING_AGENT: AgentDefinition = {
  id: 'testing-agent',
  name: 'Testing Agent',
 ...
 */
const REVIEW_AGENT: AgentDefinition = {
  id: 'review-agent',
  name: 'Review Agent',
 ...
 */
const DOCUMENTATION_AGENT: AgentDefinition = {
...
export class AgentRegistry {
  ...
  private defaultAgentId: string = 'research-agent';
  ...
  register(agent: AgentDefinition): void {
    ...
    info('agent', `Registered agent: ${agent.id} (${agent.name})`);
  }
   ...
   */
  getByTaskType(taskType: string): AgentDefinition[] {
    return this.getAll().filter(agent =>
   ...
   */
  selectAgent(taskDescription: string): AgentDefinition {
  ...
  getDefaultAgent(): AgentDefinition {
    return this.agents.get(this.defaultAgentId) || RESEARCH_AGENT;
  }
  ...
  /**
   * Register a custom agent from definition
   */
  registerCustomAgent(definition: Omit<AgentDefinition, 'isBuiltIn'>): void {
    this.register({
      ...definition,
      isBuiltIn: false,
    });
 ...
 */
export function selectAgentForTask(taskDescription: string): AgentDefinition {
