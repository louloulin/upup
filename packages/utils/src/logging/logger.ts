...
export type LogCategory = 'memory' | 'agent' | 'tools' | 'subagent' | 'mcp' | 'daemon' | 'system' | 'default' | 'compaction' | 'orchestrator' | 'post-cleanup' | 'session-compact' | 'bash' | 'hooks' | 'worktree-hooks' | 'permissions' | 'elicitation' | 'tool-hooks' | 'rate-limiter' | 'instructions' | 'stop-hooks' | 'instructions-hooks';
