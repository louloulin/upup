...
import { getPluginRegistry } from '@upup/plugins/registry';
import { isBuiltinPluginEnabled, setBuiltinPluginEnabled, getBuiltinPlugin, getAllBuiltinPlugins } from '@upup/plugins/builtin-plugins';
import type { PluginManifest, PluginCapability } from '@upup/plugins/types';
