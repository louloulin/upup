import type { AgentCapability } from '@upup/agent-runtime/registry';
/**
...
import type { AgentDefinition } from '@upup/agent-runtime/registry';
import { getAgentRegistry } from '@upup/agent-runtime/registry';
