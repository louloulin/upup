...
async function promptSetupMode(cfg: GatewayConfig, linkedPhone: string): Promise<void> {
  ...
  try {
    ...
    console.log('');
    console.log('How will you use UpUp with WhatsApp?');
    console.log('  1) Self-chat  — message yourself to talk to UpUp');
    console.log('  2) Bot phone  — this is a dedicated UpUp phone, others message it');
    ...
    console.log('');
    console.log('Enter the phone number(s) allowed to message UpUp (E.164 format, e.g. +15551234567).');
