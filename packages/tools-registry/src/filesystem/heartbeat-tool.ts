...
import { z } from 'zod';
import { upupPath } from '@upup/utils/paths.js';
import { loadGatewayConfig, saveGatewayConfig } from '@upup/gateway/config.js';
import { buildHeartbeatQuery } from '@upup/gateway/heartbeat/prompt.js';
import { loadCronStore, saveCronStore } from '@upup/cron/store.js';

const HEARTBEAT_MD_PATH = upupPath('HEARTBEAT.md');
const HEARTBEAT_JOB_NAME = 'Heartbeat';

export const HEARTBEAT_TOOL_DESCRIPTION = `
Manage your periodic heartbeat checklist (.upup/HEARTBEAT.md).
