// @ts-nocheck
/**
 * Morning brief (today plan + watchlist + audit) Command Implementation
 *
...
const commandName = 'morning-brief'
  ...
  if (!trimmed) {
    return {
      ...
      value: [
        '',
        '═══════════════════════════════════════',
        `  /${commandName} — Morning brief (today plan + watchlist + audit)`,
        '═══════════════════════════════════════',
        '  Usage:',
        '    /morning-brief                  (no args required)',
        '',
