// @ts-nocheck
/**
 * Strategy marketplace (list / show / new / publish / fork / audit) Command Implementation
 *
  ...
  if (!trimmed) {
    return {
      ...
      value: [
        '',
        '═══════════════════════════════════════',
        `  /${commandName} — Strategy marketplace (list / show / new / publish / fork / audit)`,
        '═══════════════════════════════════════',
        '  Usage:',
        '    /strategy                  (no args required)',
        '',
