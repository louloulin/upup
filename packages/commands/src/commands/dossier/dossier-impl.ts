// @ts-nocheck
/**
 * Single-page dossier for <ticker> (snapshot / freshness / thesis / triggers) Command Implementation
 *
  ...
  if (!trimmed) {
    return {
      ...
      value: [
        '',
        '═══════════════════════════════════════',
        `  /${commandName} — Single-page dossier for <ticker> (snapshot / freshness / thesis / triggers)`,
        '═══════════════════════════════════════',
        '  Usage:',
        '    /dossier <TICKER>',
        '',
