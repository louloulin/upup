// @ts-nocheck
/**
 * Portfolio review (recent plan post-mortem + Brinson) Command Implementation
 *
...
const commandName = 'portfolio-review'
  ...
  if (!trimmed) {
    return {
      ...
      value: [
        '',
        '═══════════════════════════════════════',
        `  /${commandName} — Portfolio review (recent plan post-mortem + Brinson)`,
        '═══════════════════════════════════════',
        '  Usage:',
        '    /portfolio-review                  (no args required)',
        '',
