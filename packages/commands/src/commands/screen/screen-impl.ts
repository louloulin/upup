// @ts-nocheck
/**
 * Natural-language screen (NL -> ranked results + 1-line thesis) Command Implementation
 *
  ...
  if (!trimmed) {
    return {
      ...
      value: [
        '',
        '═══════════════════════════════════════',
        `  /${commandName} — Natural-language screen (NL -> ranked results + 1-line thesis)`,
        '═══════════════════════════════════════',
        '  Usage:',
        '    /screen                  (no args required)',
        '',
